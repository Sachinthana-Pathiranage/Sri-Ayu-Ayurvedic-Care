...
const PredictionForm = () => {
  ...
  const fetchOptions = async () => {
    ...
    const handlePredict = async () => {
      ...
      try {
        // Join the selected symptoms array into a single string
        const symptomsString = selectedSymptoms.join(' '); // <-- Join symptoms here
  
        const data = {
            disease,
            treatment: selectedTreatment,
            symptoms: symptomsString, // <-- Send the joined string
            severity
        };
